...
InspectorBackend.registerEvent("FileSystem.didReadDirectory", ["requestId", "errorCode", "entries"]);
InspectorBackend.registerCommand("FileSystem.enable", [], []);
InspectorBackend.registerCommand("FileSystem.disable", [], []);
InspectorBackend.registerCommand("FileSystem.readDirectory", [{"name": "requestId", "type": "number", "optional": false}, {"name": "url", "type": "string", "optional": false}], []);
