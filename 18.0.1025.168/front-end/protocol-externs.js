 ...
 * @param {function(?Protocol.Error):void=} opt_callback
 */
RuntimeAgent.setReportExecutionContextCreation = function(enabled, opt_callback) {}
/** @param {function(?Protocol.Error):void=} opt_callback */
RuntimeAgent.setReportExecutionContextCreation.invoke = function(obj, opt_callback) {}
/** @interface */
RuntimeAgent.Dispatcher = function() {};
/**
 * @param {RuntimeAgent.ExecutionContextDescription} context
 */
RuntimeAgent.Dispatcher.prototype.isolatedContextCreated = function(context) {};
/**
